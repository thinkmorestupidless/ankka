...
import com.thinkmorestupidless.ankka.controlplane.domain.{ServiceEvent, ServiceKey}
...
object ProjectionTrigger:
   ...
   *
   * ankka has no container: a component is built by its own companion and anything it needs arrives
