---
title: Agents
description: Write an agent in Scala or Python — instructions, tools, guardrails, session memory, structured replies and compaction — and configure the model it talks to.
kind: guide
...
<!-- include: samples/multi-agent-planner/src/main/scala/planner/application/Specialists.scala#weather -->
```scala
...
<!-- include: modules/testkit/src/test/scala/com/thinkmorestupidless/ankka/testkit/WeatherAgent.scala#structured -->
```scala
...
<!-- include: modules/testkit/src/test/scala/com/thinkmorestupidless/ankka/testkit/WeatherAgent.scala#tools -->
```scala
...
<!-- include: modules/testkit/src/test/scala/com/thinkmorestupidless/ankka/testkit/WeatherAgent.scala#guarded -->
```scala
...
<!-- include: modules/testkit/src/test/scala/com/thinkmorestupidless/ankka/testkit/WeatherAgent.scala#short-memory -->
```scala
...
<!-- include: samples/multi-agent-planner/src/main/scala/Main.scala#registration -->
```scala
...
<!-- include: sdks/python/examples/shopping_cart/assistant.py -->
```python
