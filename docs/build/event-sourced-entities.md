...
<!-- include: samples/shopping-cart/src/main/scala/shoppingcart/application/ShoppingCartEntity.scala#companion -->
```scala
...
<!-- include: samples/shopping-cart/src/main/scala/shoppingcart/application/ShoppingCartEntity.scala#checkout -->
```scala
/**
 * Records the checkout and then deletes the cart.
 *
