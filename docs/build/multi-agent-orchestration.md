...
description: Coordinate several agents from a workflow — sequentially, in parallel, or chosen dynamically by another agent — sharing one session, and test the coordination with a scripted model.
kind: guide
languages: [scala, python]
components: [agent, workflow]
related: [build/agents.md, build/workflows.md, concepts/agents.md, build/testing.md]
---
...
<!-- include: samples/multi-agent-planner/src/main/scala/planner/application/PlannerWorkflow.scala#select -->
```scala
...
<!-- include: samples/multi-agent-planner/src/main/scala/planner/application/PlannerWorkflow.scala#settings -->
```scala
...
<!-- include: samples/multi-agent-planner/src/main/scala/planner/application/PlannerWorkflow.scala#parallel -->
```scala
/**
...
<!-- include: samples/multi-agent-planner/src/main/scala/planner/application/Specialists.scala#selector -->
```scala
...
<!-- include: samples/multi-agent-planner/src/main/scala/planner/application/Specialists.scala#summary -->
```scala
...
<!-- include: samples/multi-agent-planner/src/main/scala/planner/application/PlannerWorkflow.scala#summarise -->
```scala
...
<!-- include: samples/multi-agent-planner/src/main/scala/planner/application/Specialists.scala#activity -->
```scala
...
<!-- include: samples/multi-agent-planner/src/test/scala/planner/PlannerSuite.scala#script -->
```scala
...
<!-- include: samples/multi-agent-planner/src/test/scala/planner/PlannerSuite.scala#assert -->
```scala
...
<!-- include: samples/multi-agent-planner/src/test/scala/planner/PlannerSuite.scala#drain -->
```scala
