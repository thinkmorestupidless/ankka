---
title: Testing
description: Test ankka components at two levels in Scala and Python — unit test kits that run a component with nothing else, and integration test kits that run the whole service against a real database — with scripted models for agents.
kind: guide
languages: [scala, python]
components: [event-sourced-entity, key-value-entity, view, consumer, workflow, timed-action, agent, http-endpoint]
related: [concepts/effects.md, build/agents.md, get-started/first-service-scala.md, get-started/first-service-python.md]
---
...
<!-- include: samples/multi-agent-planner/src/test/scala/planner/PlannerSuite.scala#start -->
```scala
...
<!-- include: sdks/python/examples/shopping_cart/test_cart.py#workflow-test -->
```python
...
<!-- include: sdks/python/examples/shopping_cart/test_cart.py#agent-test -->
```python
...
<!-- include: sdks/python/examples/shopping_cart/test_cart.py#scripted-sidecar -->
```python
SCRIPT = json.dumps(
    [
