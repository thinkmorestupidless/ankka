---
title: How ankka works
description: The parts of ankka and how they fit together — components and the runtime inside a service, the control plane and operator that deploy it, the sidecar for other languages, and where every piece of state lives.
kind: concept
related: [concepts/components.md, concepts/effects.md, concepts/control-plane.md, concepts/polyglot.md, concepts/clustering.md]
---
