---
title: Clusters and instances
description: How a service's instances form one cluster, how entities are spread across it, how nodes find each other locally and in Kubernetes, and what that means for rollouts, failures and instance counts.
kind: concept
related: [deploy/scaling-and-rollouts.md, deploy/run-locally.md, concepts/consistency.md, reference/configuration.md]
---
