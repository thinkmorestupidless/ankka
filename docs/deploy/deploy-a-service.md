...
description: Write a service descriptor, apply it with the ankka CLI, and follow the service from UpdateInProgress to Ready, including environment variables, secrets, version declarations and Python services.
kind: guide
related: [reference/service-descriptor.md, reference/lifecycle-states.md, deploy/expose.md, operate/status-and-history.md]
---
