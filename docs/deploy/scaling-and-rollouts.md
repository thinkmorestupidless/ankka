---
title: Scale and roll out
description: Choose how many instances a service runs and how large each is, and understand how deploys, restarts and scaling change the running pods without refusing requests.
kind: guide
related: [concepts/clustering.md, deploy/deploy-a-service.md, operate/service-lifecycle.md]
---
