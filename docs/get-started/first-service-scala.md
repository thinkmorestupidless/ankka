---
title: Your first service in Scala
description: Create a Scala service from the ankka template, test it, run it against a local Postgres, watch it in the local console, and change its domain.
kind: tutorial
languages: [scala]
components: [event-sourced-entity, view, http-endpoint]
related: [get-started/install.md, get-started/deploy-locally.md, build/event-sourced-entities.md, build/testing.md]
---
