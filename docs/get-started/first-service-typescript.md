---
title: Your first service in TypeScript
description: Write a TypeScript service on Node.js with an event sourced entity and an HTTP endpoint, run it from source beside the ankka sidecar, test it with and without the sidecar, and watch it in the local console.
kind: tutorial
languages: [typescript]
components: [event-sourced-entity, http-endpoint]
related: [get-started/install.md, concepts/polyglot.md, reference/typescript-sdk.md, get-started/deploy-locally.md]
---
...
<!-- include: sdks/typescript/examples/first-service/cart.ts#entity -->
```ts
...
<!-- include: sdks/typescript/examples/first-service/api.ts#endpoint -->
```ts
...
<!-- include: sdks/typescript/examples/first-service/main.ts#main -->
```ts
...
<!-- include: sdks/typescript/examples/first-service/cart.test.ts#unit-test -->
```ts
...
<!-- include: sdks/typescript/examples/first-service/cart.test.ts#integration-test -->
```ts
