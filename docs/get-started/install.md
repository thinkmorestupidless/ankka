...
description: Install what ankka needs on your machine, install the ankka CLI with Homebrew or from a release, and make the Scala libraries and the Python and TypeScript SDKs available to your own projects.
kind: tutorial
languages: [scala, python, typescript]
related: [get-started/first-service-scala.md, get-started/first-service-python.md, get-started/first-service-typescript.md, reference/limitations.md]
---
