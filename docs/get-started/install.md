...
description: Install what ankka needs on your machine, install the ankka CLI with Homebrew or from a release, and make the Scala libraries and Python SDK available to your own projects.
kind: tutorial
languages: [scala, python]
related: [get-started/first-service-scala.md, get-started/first-service-python.md, reference/limitations.md]
---
