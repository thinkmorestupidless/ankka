---
title: The local console
description: Use `ankka local console` to see every ankka service running on your machine — its components, a form per HTTP route, the traces of recent requests, entity state and agent sessions.
kind: guide
languages: [scala, python]
related: [concepts/observability.md, deploy/run-locally.md, get-started/install.md]
---
