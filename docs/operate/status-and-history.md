...
description: Read a deployed service's status with `ankka services list` and `get`, understand every field including unconfirmed readings, and see who changed a service with `ankka services history`.
kind: guide
related: [reference/lifecycle-states.md, concepts/control-plane.md, reference/cli.md, operate/troubleshooting.md]
---
