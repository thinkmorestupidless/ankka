---
title: Install on a cloud cluster
description: Install ankka on a real Kubernetes cluster with a production kustomize overlay — a load balancer, a public wildcard certificate over DNS-01, a real base domain, images from a registry and an identity provider with no default credentials.
kind: guide
related: [platform/install-local.md, platform/networking.md, platform/identity.md, platform/databases.md]
---
