...
description: Create organizations and projects, invite members by email, manage roles, and disable or delete an organization, with the rules the control plane enforces on each.
kind: guide
related: [concepts/tenancy-and-access.md, platform/identity.md, reference/cli.md]
---
