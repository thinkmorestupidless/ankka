---
title: CLI
description: Every `ankka` command and option, how the CLI resolves its settings and credentials, its output formats and its exit codes.
kind: reference
related: [reference/control-plane-api.md, reference/service-descriptor.md, platform/identity.md]
---
