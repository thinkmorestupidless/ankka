---
title: Control plane HTTP API
description: Every route the control plane serves, with its parameters, request body, response and who may call it, plus how requests are authenticated and how errors are reported.
kind: reference
related: [reference/cli.md, reference/service-descriptor.md, platform/identity.md, platform/organizations.md]
---
...
<!-- generated:start control-plane-routes -->
