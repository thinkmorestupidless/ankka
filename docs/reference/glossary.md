---
title: Glossary
description: One or two sentences on every term ankka's documentation uses, from ACL to workflow, each with its own anchor so any page can link to the definition.
kind: reference
related: [concepts/architecture.md, concepts/components.md]
---
