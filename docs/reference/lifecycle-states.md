---
title: Service lifecycle states
description: What each of a deployed service's eight lifecycle states means, what usually causes it, what to do about it, and what an unconfirmed status is.
kind: reference
related: [operate/status-and-history.md, operate/troubleshooting.md, concepts/control-plane.md, reference/service-descriptor.md]
---
