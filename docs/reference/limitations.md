---
title: Limitations
description: What ankka does not do yet, stated plainly and grouped — the platform, networking and security, observability, components, and SDKs and releases — so you can plan around a gap before you reach it.
kind: reference
related: [reference/akka-divergences.md, operate/troubleshooting.md, platform/networking.md]
---
