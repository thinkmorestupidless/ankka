---
title: Scala SDK
description: A compact map of the Scala SDK — the artifacts, and for every component kind its base class, companion, handler declarations, effect builders and in-handler accessors.
kind: reference
languages: [scala]
components: [event-sourced-entity, key-value-entity, view, consumer, workflow, timed-action, agent, http-endpoint]
related: [concepts/components.md, concepts/effects.md, reference/python-sdk.md, build/testing.md]
---
