...
description: Every field of the JSON service descriptor that `ankka services apply` takes, with its type, default and validation rules, and the environment variables the platform reserves.
kind: reference
related: [deploy/deploy-a-service.md, reference/lifecycle-states.md, reference/cli.md, concepts/control-plane.md]
---
