...
description: A compact map of the TypeScript SDK — installing it, the shapes and codecs, and for every component kind its base class, statics, declaration functions, effect builders and testkit — plus the SDK's own development commands.
kind: reference
languages: [typescript]
components: [event-sourced-entity, key-value-entity, view, consumer, workflow, timed-action, agent, http-endpoint]
related: [concepts/polyglot.md, get-started/first-service-typescript.md, reference/python-sdk.md, reference/scala-sdk.md, reference/sidecar-protocol.md]
---
