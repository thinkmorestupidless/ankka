...
import nakka.core.*
import nakka.sdk.{CommandHandle, ComponentClient, HandlerBinding, NoArgHandle}
...
abstract class Agent:
  ...
  private[nakka] def _setContext(ctx: Option[AgentContext]): Unit = contextOpt = ctx
...
private[nakka] final case class SimpleAgentContext(
    sessionId: SessionId,
