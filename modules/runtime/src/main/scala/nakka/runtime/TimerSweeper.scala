...
import nakka.core.*
import nakka.core.effect.TimedActionEffect
import nakka.sdk.*
...
private[nakka] final class Sweep(
    database: Database,
    actions: Map[ComponentId, TimedActionDescriptor[?]],
    componentClient: ComponentClient,
    ec: ExecutionContext
  ...
  private val log: Logger = LoggerFactory.getLogger("nakka.timers")
...
private[nakka] final case class DueTimer(
    name: String,
