...
import nakka.core.{ComponentId, EntityId, Metadata}
...
private[nakka] final case class SimpleEntityContext(
    entityId: EntityId,
...
private[nakka] final case class SimpleWorkflowContextImpl(
    workflowId: EntityId,
    componentId: ComponentId,
    componentClient: ComponentClient
) extends WorkflowContext

private[nakka] final case class SimpleViewContext(
    componentId: ComponentId,
    componentClient: ComponentClient
) extends ViewComponentContext

private[nakka] final case class SimpleConsumerContext(
    componentId: ComponentId,
    componentClient: ComponentClient
) extends ConsumerContext

private[nakka] final case class SimpleCommandContext(
    entityId: EntityId,
    componentId: ComponentId,
    metadata: Metadata,
    sequenceNumber: Long
