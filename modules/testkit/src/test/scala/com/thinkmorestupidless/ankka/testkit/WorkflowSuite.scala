...
class WorkflowSuite extends munit.FunSuite:
  ...
  test("the reserved lifecycle name cannot be used by a handler") {
    ...
    val failure = intercept[IllegalArgumentException] {
      object Bad
          extends com.thinkmorestupidless.ankka.sdk.Workflow.Companion[
            TransferWorkflow,
            TransferState
          ](
            com.thinkmorestupidless.ankka.core.ComponentId("bad-workflow"),
            com.thinkmorestupidless.ankka.core.Codecs.serializer[TransferState]("transfer-state")
          ):
        def create(context: com.thinkmorestupidless.ankka.sdk.WorkflowContext) =
          new TransferWorkflow(context)
        val clash = step("ankka:lifecycle")(_.compensateStep)
      Bad.descriptor
    }
