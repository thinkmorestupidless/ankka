...
object Labels:
  ...
  val ProjectKey: String   = "ankka.thinkmorestupidless.com/project"
  val ServiceKey: String   = "ankka.thinkmorestupidless.com/service"
   ...
   */
  val GenerationKey: String = "ankka.thinkmorestupidless.com/generation"
  ...
  def ownedByAnkka(labels: java.util.Map[String, String]): Boolean =
    labels != null && ownedByAnkka(labels.asScala.toMap)
  ...
  def ownerReference(resource: AnkkaService): OwnerReference =
    new OwnerReferenceBuilder()
      ...
      .withKind(AnkkaServiceDefinition.kind)
