...
import com.thinkmorestupidless.ankka.operator.cnpg.{CnpgObjectState, DatabaseObservation}
...
class ProvisioningSuite extends munit.FunSuite:
  ...
  private val spec = AnkkaServiceSpec(projectId = "checkout", serviceName = "cart", generation = 1L)
